        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="">
                <tr>
                    <th
                        scope="col"
                        class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider font-bold"
                    >
                        Advertises
                    </th>
                    <th
                        ...
                        <td class="pr-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="ml-4 flex items-center">
                                    ...
                                    <div
                                        href="/userinfo"
                                        class="text-sm font-medium text-gray-900 flex cursor-pointer"
                                    >
                                        MGL
                                    </div>
                                </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div className="flex">
                                ...
                                <div className="flex flex-col font-bold">
                                    <span>10,000,000.00 MGL</span>
                                    <span>$50.00 - $5000.00</span>
                                </div>
                            </div>
                        </td>
