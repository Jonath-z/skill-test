...
function Nav(props) {
    ...
    const buySubmenuData = [
        {
            icon: <BsCreditCard2Front size={30} className="inline mx-4" />,
            title: t("Credit/Debit Card"),
            subtitle: t("Buy crypto via card"),
        },
        {
            icon: <BsPeople size={30} className="inline mx-4" />,
            title: t("P2P Trading"),
            subtitle: t("Bank transfer and 100+ options"),
            url: "/p2p",
        },
    ...
    const menu = (
        <div className="mt-4 rounded-xl py-4 pl-2 pr-8 flex bg-white flex-wrap shadow">
            <div className="flex flex-col flex-wrap">
                <Link
                    to="/"
                    className="text-md grayButton pl-2 pr-8 py-2  rounded-md"
                >
                    <BsCurrencyExchange size={20} className="inline mr-2" />
                    {t("Exchange")}
                </Link>
                <br />
                <Link
                    ...
                    className="text-md grayButton pl-2 pr-8 py-2  rounded-md"
                >
                    <MdHomeRepairService size={20} className="inline mr-2" />
                ...
                <Link
                    ...
                    className="text-md grayButton pl-2 pr-8 py-2 rounded-md"
                >
                    <AiOutlineSwap size={20} className="inline mr-2" />
                    {t("Swap")}
                </Link>
            </div>
            <div className="flex flex-col flex-wrap">
                <Link
                    ...
                    className="text-md grayButton pl-2 pr-8 py-2 rounded-md"
                >
                    <HiAcademicCap size={20} className="inline mr-2" />
                    {t("Academy")}
                </Link>
                <br />
                <Link
                    ...
                    className="text-md grayButton pl-2 pr-8 py-2 rounded-md"
                >
                    <FaHandHoldingHeart size={20} className="inline mr-2" />
                    {t("Charity")}
                </Link>
                <br />
                <Link
                    ...
                    className="text-md grayButton pl-2 pr-8 py-2 rounded-md"
                >
                    <GrLaunch size={20} className="inline mr-2" />
                    {t("LaunchPad")}
                </Link>
            </div>
        </div>
            ...
            <div className="mt-2">
                {buySubmenuData.map((item, idx) => (
                    <a
                        key={idx}
                        href={item.url}
                        className="flex items-center  grayButton w-full rounded-lg p-2"
                    >
                        {item.icon}
                        <div>
    ...
    return (
        <>
            {!regPage ? (
                <div
                    className={`flex  h-20  text-black ${props.className} mt-3 text-xs xl:text-sm`}
                >
                    ...
                    <div className="hidden md:block py-5">
                        <div className="flex  items-center rightBorder h-4 h-10 ">
                            {userData == undefined || userData == "" ? (
                                <>
                                    <Link to="/login">
                                        <button className="mx-4 xl:mx-8">
                                            {t("Log In")}
                                        </button>
                                    </Link>
                                    <button
                                        className="mr-4 xl:mr-8 myButton text-white myBule px-3 xl:px-6 "
                    ...
                    <div className="hidden md:block py-5">
                        <div className="flex  items-center  h-10">
                            {localStorage.getItem("publicKey") ? (
                                <Link to="/wallet/0">
                                    <button className="mx-4  myButton  myBule text-white px-3 xl:px-6  ">
                                        {" "}
                                        {t("Wallet")}{" "}
                                    </button>
                                </Link>
                            ...
                            <button className=" myButton  bg-blue-100 w-20 ">
                                {" "}
                                {t("USD")}{" "}
                            </button>
                        </div>
                    ...
                    <div className="md:hidden py-5 flex ">
                        {!localStorage.getItem("userInfo") ? (
                            <button
                                className="mr-4  myButton text-white myBule px-12 text-sm"
                                onClick={goToRegister}
                            >
                                {t("Register")}
                            </button>
                            ...
                            <Link to="/wallet/0">
                                <button className="mr-4  myButton  myBule text-white  px-12 text-sm ">
                                    {" "}
                                    {t("Wallet")}{" "}
                                </button>
                            </Link>
