        ...
        if (checkNumber(value))
            presaleData.setPresaleData((prevState) => {
                return {
                    ...prevState,
                    toAmount: value,
                    fromAmount: Number(value) * prevState.price,
                };
            });
    };
        ...
        if (checkNumber(value))
            presaleData.setPresaleData((prevState) => {
                return {
                    ...prevState,
                    fromAmount: value,
                    toAmount: Number(value) / prevState.price,
                };
            });
    };
                        ...
                        <Col span={16}>
                            <p className=" bg-gray-200 w-full text-center p-1.5">
                                {presaleData.presaleData.symbol ? (
                                    <>
                                        {presaleData.presaleData.symbol.toLowerCase() ===
                                        "mgl" ? (
                                            <img
                                            ...
                                            <Icon
                                                ...
                                                name={presaleData.presaleData.symbol.toLowerCase()}
                                                size={30}
                                            />
                                        )}
                                    </>
            ...
            {mode == 0 ? (
                <>
                    ...
                    <Row gutter={16} className="text-center">
                        <Col span={12}>
                            <Button
                                size="large"
                                className="access-button  mb-8 mt-4 w-full text-sm"
                                onClick={() => setMode(1)}
                            >
                                {t("Yes, continue purchase")}
                            </Button>
                        </Col>
                        ...
                        <Col span={12}>
                            <Button
                                size="large"
                                className="  mb-8 mt-4 w-full text-sm"
                                onClick={props.sendMe}
                            >
                                {t("No, send me BNB")}
                            </Button>
                        </Col>
                ...
                <Row gutter={16}>
                    <Col span={10} offset={2}>
                        <Button
                            size="large"
                            className="access-button  mb-8 mt-4 w-full"
