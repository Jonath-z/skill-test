...
function WalletSend(props) {
    ...
    const checkConfirm = (token, amount, gasLimit, gasPrice, network) => {
        let selToken = props.tokensInfo.filter(
        ...
        let feeToken = props.tokensInfo.filter(
            (item) =>
                item.address === "0x0000000000000000000000000000000000001010",
        );
                ...
                <Col className="p-4" span={24}>
                    <Row>
                        ...
                        <Col span={8}>
                            ...
                            />
                            <p className="myColor1 text-lg mt-8">
                                {t("Memo(Optional)")}
                            </p>
                            <TextArea
                                placeholder={t("Memo")}
