...
class WalletService {
    ...
    static async createWallet(userId, keyphrase, locale) {
        ...
        let wallet = new Wallet("polygon-mainnet").createWallet(
            userId,
            keyphrase,
        );
        ...
        const body = i18n.__({
            phrase: "Your MGL Exchange wallet has been created sucessfully. Thank you.",
            locale: locale,
        });
