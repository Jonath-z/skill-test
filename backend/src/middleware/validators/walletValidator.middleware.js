...
exports.createWalletSchema = [
    body("keyphrase").exists().withMessage("KeyPhrase is required"),
...
exports.accessWalletWithPrivateKeySchema = [
    body("privateKey").exists().withMessage("PrivateKey is required"),
    function (req, res, next) {
        var errorValidation = validationResult(req);
        if (errorValidation.errors.length !== 0) {
            return res.send({
...
exports.addTokenSchema = [
    ...
    body("token_symbol").exists().withMessage("Token Symbol is required"),
    function (req, res, next) {
        var errorValidation = validationResult(req);
        if (errorValidation.errors.length !== 0) {
            return res.send({
...
exports.sendTokenSchema = [
    ...
    body("gasPrice").exists().withMessage("Amount is required"),
    function (req, res, next) {
        var errorValidation = validationResult(req);
        if (errorValidation.errors.length !== 0) {
            return res.send({
    ...
    body("gasLimit").exists().withMessage("Amount is required"),
    function (req, res, next) {
        var errorValidation = validationResult(req);
        if (errorValidation.errors.length !== 0) {
            return res.send({
