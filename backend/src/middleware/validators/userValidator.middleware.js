...
exports.createUserSchema = [
  ...
  body("email_verify")
    ...
    .isLength({ min: 4 })
    .withMessage("Email verification code should contain 4 characters")
    .isLength({ max: 4 })
    .withMessage("Email verification code should contain 4 characters"),
  function (req, res, next) {
    var errorValidation = validationResult(req);
    console.log({ body: req.body, leng: errorValidation.errors.length });
    if (errorValidation.errors.length !== 0) {
  ...
  body("invite_code")
    ...
    .isNumeric()
    .withMessage("Invite code must contain numeric characters"),
  function (req, res, next) {
    var errorValidation = validationResult(req);
    if (errorValidation.errors.length !== 0) {
      return res.send({
