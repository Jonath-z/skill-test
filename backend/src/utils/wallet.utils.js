...
class Wallet {
    ...
    createWallet(userId, keyphrase) {
        ...
        let polygonmain_assets =
            "0xcbAe2a4625c5CB99391D8F1a0F5121B3E5A176bb,0x0000000000000000000000000000000000001010";
        let polygontest_assets =
            "0xcbAe2a4625c5CB99391D8F1a0F5121B3E5A176bb,0x0000000000000000000000000000000000001010";
        let network = "0,1";
        let bsc_tokensymbol = "mgl,BNB,BUSD,ETH";
        let bscmain_assets =
            "0xcbAe2a4625c5CB99391D8F1a0F5121B3E5A176bb,0x0000000000000000000000000000000000001010,0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,0x2170Ed0880ac9A755fd29B2688956BD959F933F8";
        let bsctest_assets =
            "0xcbAe2a4625c5CB99391D8F1a0F5121B3E5A176bb,0x0000000000000000000000000000000000001010,0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,0x2170Ed0880ac9A755fd29B2688956BD959F933F8";
    ...
    async sendToken(
        ...
        try {
            if (token === "0x0000000000000000000000000000000000001010") {
                ...
                let signed_tx = await this.web3.eth.accounts.signTransaction(
                    tx,
                    privateKey,
                );
                ...
                let transfer = await contract.methods.transfer(
                    destination,
                    value,
                );
